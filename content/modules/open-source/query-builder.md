...
description: Create and run SQL statements from within Gibbon, exporting the results to Excel. Gain access to a library of maintained SQL statements with a <a target="_blank" href='http://gibbonedu.com'>Gibbon Catalyst License</a>.
...
release:
    - version: v2.2.01
      url: https://github.com/GibbonEdu/module-queryBuilder/archive/refs/tags/v2.2.01.zip
      date: 2025-06-19
      core: v28.0.00
---
